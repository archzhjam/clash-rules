...
│   ├── emby.list              # 🎬 Emby（15 条，JavScraper 刮削站 + 欧美站域名，走日本/美国非Gemini url-test）
...
| 规则集 | 数量 | 兼容性 |
|---|---|---|
| netflix / llm / direct / microsoft / apple / telegram / bilibili / facebook / media / tiktok / emby / block | 1062 | ✅ 全平台（DOMAIN/SUFFIX/KEYWORD/IP-CIDR/DST-PORT） |
